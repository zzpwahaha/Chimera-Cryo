...
void processData(){
  ...
  //check if there are errors in the data or the serial communication timeout is reached or ramp segments exceed array size
  if (error == false && serialTimeout < 10000 && rampCount0 < 30 && rampCount1 < 30 ){
