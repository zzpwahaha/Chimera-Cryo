...
PictureViewer::PictureViewer(QWidget* parent, Qt::WindowFlags flag, QString sID)
    : QWidget(parent, flag)
{
    /***********************************************************************/
    ...
    connect(SP_ACCESS(m_pFrameObs)->ImageProcessThreadPtr().data(),
        &ImageProcessingThread::logging, this, &PictureViewer::onFeedLogger);
    ...
    connect(m_pImgCThread, &ImageCalculatingThread::imageReadyForPlot,
        this, &PictureViewer::onimageReadyFromCalc);
    connect(this, &PictureViewer::acquisitionRunning, this, &PictureViewer::onImageCalcStartStop);
    ...
    connect(m_pImgCThread, &ImageCalculatingThread::logging, this, &PictureViewer::onFeedLogger);
...
void PictureViewer::OnShowContextMenu(const QPoint& pos)
{
    m_ContextMenu->exec(QCursor::pos());
}
...
void PictureViewer::onSetCurrentFPS(const QString& sFPS)
{
    m_FramerateButton->setText(QString::fromStdString(" FPS: ") + sFPS + " ");
}

void PictureViewer::onResetFPS()
{
    SP_ACCESS(m_pFrameObs)->resetFrameCounter(false);
}

void PictureViewer::onSetFrameCounter(const unsigned int& nNumberOfFrames)
{
    m_FramesLabel->setText("Frames: " + QString::number(nNumberOfFrames) + " ");
}

void PictureViewer::onImageCalcStartStop(bool start)
{
...
void PictureViewer::onimageReadyFromCalc()
{
...
void PictureViewer::SetCurrentScreenROI()
{
...
void PictureViewer::ResetFullROI(bool notStartReStart)
{
    if (!notStartReStart)
    {
        emit m_Controller->acquisitionStartStop("AcquisitionStopWidthHeight");
...
void PictureViewer::updateExposureTime()
{
...
bool PictureViewer::isStreamingAvailable()
{
...
VmbError_t PictureViewer::onPrepareCapture()
{
    FeaturePtr pFeature;
...
void PictureViewer::on_ActionFreerun_triggered()
{
    VmbError_t error;
    FeaturePtr pFeat;
...
VmbError_t PictureViewer::releaseBuffer()
{
...
VmbError_t PictureViewer::getOpenError() const
{
    return m_OpenError;
}
...
void PictureViewer::onAcquisitionStartStop(const QString& sThisFeature)
{
...
void PictureViewer::on_ActionSaveCameraSettings_triggered()
{
...
void PictureViewer::on_ActionLoadCameraSettings_triggered()
{
...
/* Saving an image */
void PictureViewer::on_ActionSaveAs_triggered()
{
