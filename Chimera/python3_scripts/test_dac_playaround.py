...
class DAC_ramp_tester:
  ...
  def dac_seq_write_points(self):
    ...
    # points0.append(DAC_seq_point( address= 0 , time =  100000 ,start = 36044 ,incr =  0 ,chan= 0 ,clr_incr= 1 ))
    # points0.append(DAC_seq_point( address= 1 , time =  100001 ,start = 49151 ,incr =  0 ,chan= 2 ,clr_incr= 1 ))
    # points0.append(DAC_seq_point( address= 2 , time =  110000 ,start = 45874 ,incr =  8589228 ,chan= 0 ,clr_incr= 0 ))
    # points0.append(DAC_seq_point( address= 3 , time =  110001 ,start = 32767 ,incr =  6012994 ,chan= 2 ,clr_incr= 0 ))
    # points0.append(DAC_seq_point( address= 4 , time =  208000 ,start = 52296 ,incr =  8650752 ,chan= 0 ,clr_incr= 0 ))
    # points0.append(DAC_seq_point( address= 5 , time =  210000 ,start = 52428 ,incr =  0 ,chan= 0 ,clr_incr= 1 ))
    # points0.append(DAC_seq_point( address= 6 , time =  608000 ,start = 55613 ,incr =  5963776 ,chan= 2 ,clr_incr= 0 ))
    # points0.append(DAC_seq_point( address= 7 , time =  610000 ,start = 55704 ,incr =  0 ,chan= 2 ,clr_incr= 1 ))
