...
void MakoSettingControl::initialzePreset()
{
    ...
    if (modeName.find("G-319B") != std::string::npos || 
        modeName.find("G-125B") != std::string::npos ||
        modeName.find("G-507B") != std::string::npos) { // this is a global shutter camera, does not have "SensorShutterMode" feature
    }
    else {
