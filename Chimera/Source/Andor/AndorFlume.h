...
class AndorFlume{
	public:
		...
		void setEnumString            (const AT_WC* Feature,  AT_WC* String);
		...
		void setString                (const AT_WC* Feature,  AT_WC* Value);
		void getString                (const AT_WC* Feature,  AT_WC* Value,  int StringLength);
