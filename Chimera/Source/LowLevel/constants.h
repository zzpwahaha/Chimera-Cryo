...
//#define B240_COMPUTER
#define B240_COMPUTER_TEST
...
constexpr auto PYTHON_HOME = L"D:\\Anaconda3\\";

constexpr auto CODE_ROOT = "D:\\Chimera\\Chimera-Control-Mark";
...
const std::string DM_FLAT_PROFILE = DM_PROFILES_LOCATION + "\\flatProfile.txt";
	...
	const std::string PYTHON_INPUT_LOCATION = "C:/Users/Regal-Lab/Code/Chimera-Control/Debug-Output/";
	const std::string DATA_ANALYSIS_CODE_LOCATION = "C:\\Users\\Regal-Lab\\Code\\Data_Analysis_Control\\";
	const std::string LIB_PATH = str(CODE_ROOT) + "\\Waveforms-Library\\dummyLib\\";
	const std::string DEFAULT_SCRIPT_FOLDER_PATH = str(CODE_ROOT) + "\\Default-Scripts\\";
	const std::string CODE_LOGGING_FILES_PATH = "D:\\Code Versions\\";
	const std::string ACTUAL_CODE_FOLDER_PATH = str(CODE_ROOT) + "\\Chimera\\";
	const std::string PROFILES_PATH = str(CODE_ROOT) + "\\Profiles\\";
	...
	const piezoSetupInfo PIEZO_3_INFO = { PiezoType::NONE, "COM11", "PIEZO_CONTROLLER_3", true, false };
	const piezoSetupInfo IMG_PIEZO_INFO = { PiezoType::NONE, "COM8", "IMAGING_PIEZO", false, true };
	const std::string DM_PROFILES_LOCATION = str(CODE_ROOT) + "\\DM-Library";
	const std::string DM_FLAT_PROFILE = DM_PROFILES_LOCATION + "\\flatProfile.txt";
#endif
