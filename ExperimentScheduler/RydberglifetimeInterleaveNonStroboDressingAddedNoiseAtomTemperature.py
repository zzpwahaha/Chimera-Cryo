...
00000000000000000000"""
    ...
    def lifetime(self, exp_idx, exp_name_prefix, exp_name_postfix = '', timeout_control={"use": True, "timeout": 6000}):
        script_name = "rydberg_420_1013_excitation_SLM_dressing_rearrangement_nostrobing_releaserecapture.mScript"
        ...
        config_file.config_param.update_variable("time_scan_us", constant_value=40) 
        ...
        config_file.config_param.update_variable("time_scan_us_2", scan_type="Variable", 
                                                new_initial_values=[0.01,50], new_final_values=[30.01,100])
...
if __name__ == "__main__":
    ...
    EXP_NAME_PREFIX_BASE = "N-50-0.01-5x14-0.0V-420BLUE"

    NUM_LIFETIME_SEGMENTS = 2
    LIFETIME_REPETITIONS = 30*NUM_LIFETIME_SEGMENTS
    RABI_420_FREQ = 587.03 #587.2 #583.8 #582.795 #587.9 #585.037 #583.868 #529.08 #578.048   #578.091 #577.977 #578.096 #576.334 #578.271 #578.656 #578.56 # MHz
    AVALANCHE_420_FREQ = RABI_420_FREQ-1 # MHz

    CURRENT_EOM_FREQ = 586.03   #RABI_420_FREQ
    ...
    INJECTED_NOISE = [50, 0, 2,17.6, 39.6, 25,] #mV
    # INJECTED_NOISE = [0] #mV
    ...
    for idn, injected_noise in enumerate(INJECTED_NOISE):
        EXP_NAME_PREFIX = EXP_NAME_PREFIX_BASE + f'-NOISE{injected_noise:.1f}mV-RR'
