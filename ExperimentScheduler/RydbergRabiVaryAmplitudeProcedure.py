...
def resonace_scan(exp_idx, ryd420_amplitude, timeout_control = {'use':True, 'timeout':1000}):
    ...
    config_file.config_param.update_variable("ryd420_resonance", scan_type="Variable", new_initial_values=[CENTER_FREQ-scan_range_half], new_final_values=[CENTER_FREQ+scan_range_half])
