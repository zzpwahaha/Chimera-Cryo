...
00000000000000000000"""
    ...
    def lifetime(self, trap_depth, exp_idx, exp_name_prefix, exp_name_postfix = '', timeout_control={"use": True, "timeout": 6000}):
        ...
        config_file.config_param.update_variable("time_scan_us", scan_type="Variable", 
                                                new_initial_values=[0.01], new_final_values=[300.01]) #60, 5x5, 50 1x1, 60 1x1
...
if __name__ == "__main__":
    RYDBERG_420_SETPOINT = 0.024 #0.01 #0.002 #-0.005 #-0.0099 #-0.0093 #-0.0069 # -0.0072 #-0.0096
    RYDBERG_1013_SETPOINT = 4 #2.25 #4, 2.25
    RYDBERG_RABI_PI_TIME = 0.41 #0.57 #0.73 #0.91 #0.41
    RYDBERG_RABI_SCAN_TIME = 3.6 #4.2 #5.4 #7.2 #3.6

    EXP_NAME_PREFIX_BASE = "N-60-0.01-1x1-0.0V-TD"

    NUM_LIFETIME_SEGMENTS = 2
    LIFETIME_REPETITIONS = 200*NUM_LIFETIME_SEGMENTS
    RABI_420_FREQ = 577.6 #583.439 #577.62 #583.524 #577.624 #587. #583.8 #582.795 #587.9 #585.037 #583.868 #529.08 #578.048   #578.091 #577.977 #578.096 #576.334 #578.271 #578.656 #578.56 # MHz
    AVALANCHE_420_FREQ = RABI_420_FREQ-1 # MHz
    EOM_FREQ_AT_0p01_DEPTH = 577.600

    CURRENT_EOM_FREQ = 577.6  #RABI_420_FREQ
