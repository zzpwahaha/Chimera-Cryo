...
config_name = "siteSelectiveIonization.Config"
config_path = "C:/Chimera/Chimera-Cryo/Configurations/SiteSelectiveIonization/" + config_name
...
00000000000000000000"""
    ...
    def lifetime(self, exp_idx, exp_name_prefix, exp_name_postfix = '', timeout_control={"use": True, "timeout": 6000}):
        script_name = "rydberg_420_1013_excitation_SLM_rearrangement_AODIonization_dressing.mScript"
        gscript_name = "C:/Chimera/Chimera-Cryo/Configurations/SiteSelectiveIonization/rearrangement_5x7.gScript"

        exp.open_configuration("\\SiteSelectiveIonization\\" + config_name)
        ...
        # config_file.config_param.update_variable("ryd420_amplitude", constant_value=-0.0093) #-0.0069 # -0.0072 #-0.0096
        # config_file.config_param.update_variable("ryd1013_amplitude", constant_value=2.25) #4
        config_file.config_param.update_variable("ryd420_amplitude", constant_value=0.15) 
        config_file.config_param.update_variable("ryd1013_amplitude", constant_value=0.02) 
        ...
        exp.open_configuration("\\SiteSelectiveIonization\\" + config_name)
        exp.open_master_script("\\SiteSelectiveIonization\\" + script_name)
    ...
    def rabi(self, exp_idx, exp_name_prefix, exp_name_postfix = '', timeout_control={"use": True, "timeout": 1800}):
        ...
        gscript_name = "C:/Chimera/Chimera-Cryo/Configurations/SiteSelectiveIonization/rearrangement_1x7_Rabi.gScript"
        exp.open_configuration("\\SiteSelectiveIonization\\" + config_name)
...
if __name__ == "__main__":
    ...
    EXP_NAME_PREFIX = "N-50-0.01-5x14-0.0V-420BLUE"

    NUM_LIFETIME_SEGMENTS = 32
    LIFETIME_REPETITIONS = 60*NUM_LIFETIME_SEGMENTS
    RABI_420_FREQ = 580.1 #581.3 #580.1 #583.8 #582.795 #587.9 #585.037 #583.868 #529.08 #578.048   #578.091 #577.977 #578.096 #576.334 #578.271 #578.656 #578.56 # MHz
    AVALANCHE_420_FREQ = RABI_420_FREQ-1 # MHz

    CURRENT_EOM_FREQ = 581.423+0.75 #RABI_420_FREQ
