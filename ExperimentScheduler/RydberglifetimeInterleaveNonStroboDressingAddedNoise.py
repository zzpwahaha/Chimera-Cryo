...
if __name__ == "__main__":
    ...
    RABI_420_FREQ = 583.4 #577.624 #587. #583.8 #582.795 #587.9 #585.037 #583.868 #529.08 #578.048   #578.091 #577.977 #578.096 #576.334 #578.271 #578.656 #578.56 # MHz
    AVALANCHE_420_FREQ = RABI_420_FREQ-1 # MHz

    CURRENT_EOM_FREQ = 582.4  #RABI_420_FREQ
    ...
    # INJECTED_NOISE = [400, 0, 25, 75, 192, 50, 125,300] #mV
    # INJECTED_NOISE = [75, 50, 125,192, 300] #mV

    # INJECTED_NOISE = [75., 192., 25., 125., 0., 50.] #mV
    # INJECTED_NOISE = [0., 50.] #mV
    # INJECTED_NOISE = [125] #mV
    INJECTED_NOISE = [25] #mV
